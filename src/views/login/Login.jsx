...
export const Login = () => {
  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex flex-col items-center justify-center bg-white border border-gray rounded-lg shadow-md p-4 w-1/4'>
        ...
        <div className='text-center'>
          <form onSubmit={handleSubmit}>
            ...
            <button className='bg-green w-full py-2 rounded-lg text-white font-bold text-xl mt-5 mb-2'>Iniciar sesión</button>
          </form>
